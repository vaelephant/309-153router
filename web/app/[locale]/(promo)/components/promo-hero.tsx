...
const STAT_KEYS = [
  { icon: Users, labelKey: "promo.statUsers" as const, value: 2860, suffix: "+" },
  { icon: TrendingDown, labelKey: "promo.statSavings" as const, value: 37, suffix: "%" },
  { icon: Coins, labelKey: "promo.statRewards" as const, value: 12400, prefix: "¥" },
]

export function PromoHero({ registerHref, inviteCode }: PromoHeroProps) {
  const { t, locale } = useI18n()
  const counts = STAT_KEYS.map((s) => useCountUp(s.value, 2000))
