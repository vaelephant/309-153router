...
export function PromoShare({ registerHref, inviteCode }: PromoShareProps) {
  ...
  const inviteCodeLine = inviteCode
    ? t("promo.shareTemplateInviteCode", { code: inviteCode })
    : ""
  const shareText = t("promo.shareTemplate", { url: shareUrl, inviteCode: inviteCodeLine })
  const wechatText = t("promo.wechatTemplate", { url: shareUrl })
        ...
        <div className="space-y-4">
          ...
          >
            ...
            >
              ...
              {copiedLink ? t("promo.copied") : t("promo.copyLink")}
            </Button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              {copiedText ? t("promo.copiedCheck") : t("promo.copyMoment")}
            </button>
          </div>
        </div>
      </div>
