...
export function AnalyticsOverview({ data, loading, days }: AnalyticsOverviewProps) {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: Hash,
      lowerBetter: false,
      subtitle: `${t("analytics.input")} ${formatTokens(current.total_input_tokens)} / ${t("analytics.output")} ${formatTokens(current.total_output_tokens)}`,
    },
    {
    ...
    {
      label: t("analytics.smartRoutingSavings"),
            ...
            <CardContent className="p-4">
              ...
              <div className="mt-1 flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-muted-foreground">
                  {t("analytics.vsPrevDays", { days: String(days) })}
                </span>
              </div>
              {card.subtitle && (
