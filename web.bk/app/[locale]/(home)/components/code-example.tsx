...
const TAB_IDS = ["javascript", "python", "curl"] as const
const TAB_KEYS = ["codeExample.tabJs", "codeExample.tabPy", "codeExample.tabCurl"]
...
export function CodeExample() {
  ...
  const bullets = [t("codeExample.bullet0"), t("codeExample.bullet1"), t("codeExample.bullet2"), t("codeExample.bullet3")]
          ...
          <div className="flex flex-col justify-center lg:sticky lg:top-24 text-base">
            ...
            >
              ...
              <span style={{ display: 'block', marginTop: 'var(--space-2)', fontSize: '14px', color: 'var(--color-text-body)', opacity: 0.9 }}>
                {t("codeExample.subtitleNote")} <code style={{ fontFamily: 'var(--font-mono)', padding: '0 4px', borderRadius: 4, backgroundColor: 'var(--color-bg-muted)' }}>http://localhost:9115/v1</code>{t("codeExample.subtitleNoteEnd")}
              </span>
            </p>
            <ul 
